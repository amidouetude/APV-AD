...
albedo~\citep{monteith2008}. The angle of incidence for a south-facing
fixed-tilt surface is:
\begin{equation}
    \cos\theta_i = \sin\alpha_s\cos\beta
        + \cos\alpha_s\sin\beta
    \label{eq:aoi}
\end{equation}
...
by the daily temperature range and extraterrestrial radiation estimated
from the PVGIS-SARAH3 GHI profile. The Hargreaves--Samani method was
...
AD unit --- occupying the same total area. Each component is defined
as follows.
