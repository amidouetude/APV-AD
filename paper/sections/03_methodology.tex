...
\begin{equation}
    ...
    \label{eq:aoi}
\end{equation}
This expression is the closed-form relation used here for a fixed due-south collector at every
...
An eLER greater than 1.0 indicates that the integrated APV--AD system
...
\begin{itemize}[leftmargin=*, noitemsep]
	...
	This provides a non-circular reference that is
...
The DE configuration follows common recommendations~\citep{storn1997, das2011}:
...
landscape reaches its optimum at the physical constraint boundary,
where maximum panel density simultaneously maximises
