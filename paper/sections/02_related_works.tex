...
become the dominant economic model in European
...
\hspace{1cm}The first study to explicitly couple agrivoltaic and
...
dominant valorisation strategy --- a finding that directly motivates
...
(\SI{2050}{kWh\,m^{-2}}), and acute energy poverty creates arguably
the strongest case for integrated APV--AD deployment. The inclusion of
Ouagadougou, Burkina Faso in the present study --- alongside Konya
(BSk), Almer\'{i}a (BSh hot), and Freiburg (Cfb) --- enables the first
quantitative comparison of APV--AD performance across the full
semi-arid-to-temperate spectrum.

The present study is, to the authors' knowledge, the first to:
(i) apply a joint APV--AD optimizer across four climate zones,
(ii) introduce a three-component eLER as the optimization objective,
(iii) identify and mechanistically explain a non-monotone relationship
between annual solar resource and eLER through the PAR-saturation
mechanism, and
(iv) provide a 4E analysis --- Energetic, Economic, Energo-economic,
