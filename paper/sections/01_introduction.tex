...
effects~\citep{pal2024, temiz2024}. One early study to couple APV and AD
...
\begin{enumerate}[leftmargin=*, label=\textbf{C\arabic*:}]
    ...
    \item \textbf{Proposed three-component eLER metric} (G1): $eLER =
    ...
    correcting the systematic underestimation of up to 3.5$\times$
